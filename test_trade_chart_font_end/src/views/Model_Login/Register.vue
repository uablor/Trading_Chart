  ...
  <Homepage/>
    <div class="relative">
          ...
          <form @submit.prevent="register_user" class="space-y-4">
            ...
            <div class="text-left mt-3 \">
              <input 
                ...
                required
                class="mt-1 block cursor-pointer w-full p-2 border border-gray-600 bg-gray-700 rounded focus:ring focus:ring-blue-500"
              />
            </div>
      ...
      <div v-if="formData.isConfirmed" class="success-message">
        Checkbox is checked: You have confirmed that you are 18+ and accept the policy.
      </div>
